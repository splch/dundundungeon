...
LCCFLAGS_gb     = -Wm-yc -Wm-ys -Wm-yj # GBC+SB compatible & non-Japanese
LCCFLAGS_gbc    = -Wm-yc -Wm-ys -Wm-yj # Same as .gb
LCCFLAGS_pocket = # Usually the same as required for .gb
LCCFLAGS_duck   = # Usually the same as required for .gb
LCCFLAGS_sms    =
LCCFLAGS_gg     =
